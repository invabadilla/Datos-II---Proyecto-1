...
Definición en la línea 12716 del archivo json.\+hpp.
...
Definición en la línea 12719 del archivo json.\+hpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{12720         : oa(std::make\_shared<output\_vector\_adapter<CharType>>(vec)) \{\}}
...
Definición en la línea 12722 del archivo json.\+hpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{12723         : oa(std::make\_shared<output\_stream\_adapter<CharType>>(s)) \{\}}
...
Definición en la línea 12725 del archivo json.\+hpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{12726         : oa(std::make\_shared<output\_string\_adapter<CharType, StringType>>(s)) \{\}}
...
Definición en la línea 12728 del archivo json.\+hpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{12729     \{}
\DoxyCodeLine{12730         \textcolor{keywordflow}{return} oa;}
\DoxyCodeLine{12731     \}}
